...
from wheatly.stt.base import STTBackend
...
def serve(
    ...
    print(f"wheatly STT server listening on http://{host}:{port}/v1")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="wheatly-stt-server")
